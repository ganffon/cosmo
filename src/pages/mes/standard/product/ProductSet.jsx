...
function ProductSet(isEditMode, productGbnList, productModelList, productTypeList, productTypeSmallList, unitList) {
  ...
  const columns = [
    ...
    col.list("prod_type_id", "prod_type_nm", CN.prod_type_nm, productTypeList, isEditMode),
    col.list("prod_type_small_id", "prod_type_small_nm", CN.prod_type_small_nm, productGbnList, isEditMode),
    ...
    col.list("unit_id", "unit_nm", CN.unit_nm, unitList, isEditMode, C.WIDTH_SUPER_SHORT),
    ...
    col.number("mat_order_min_qty", CN.mat_order_min_qty, isEditMode, C.U, true),
    col.number("mat_supply_days", CN.mat_supply_days, isEditMode, C.U, true),
    col.check("sal_order_fg", CN.sal_order_fg, isEditMode, C.U, true),
    col.check("inv_use_fg", CN.inv_use_fg, isEditMode, C.U, true),
    col.number("inv_unit_qty", CN.inv_unit_qty, isEditMode, C.U, true),
    ...
    col.number("prd_min", CN.prd_min, isEditMode, C.U, true),
    col.number("prd_max", CN.prd_max, isEditMode, C.U, true),
