...
function Partner(props) {
  ...
  const { rowHeaders, rowHeadersModal, header, columns, columnsModal, columnOptions, inputSet } = PartnerSet(
    isEditMode,
    partnerTypeList
  );
  ...
  const onClickGrid = (e) => {
    disRow.handleClickGridCheck(e, isEditMode, ["use_fg", "vendor_fg", "customer_fg"]);
  };
