...
function StoreSet(isEditMode) {
  ...
  const columns = [
    ...
    col.check("final_insp_store_fg", CN.final_insp_store_fg, isEditMode, C.U, true),
    col.check("outsourcing_store_fg", CN.outsourcing_store_fg, isEditMode, C.U, true),
    col.check("available_store_fg", CN.available_store_fg, isEditMode, C.U, true),
    col.text("position_type", CN.position_type, isEditMode, C.U, C.WIDTH_MIDDLE),
