...
function ItfPackingCreateSet() {
  ...
  const colPacking = [
    ...
    col.text("corp_code", "회사코드", false, true),
    col.text("plce_code", "사업장코드", false, true),
  ...
  const colErpOrder = [
    ...
    col.text("corp_code", "회사코드", C.U, true, C.WIDTH_SHORT, "center", true, "text"),
    col.text("plce_code", "사업장코드", C.U, true, C.WIDTH_SHORT, "center", true, "text"),
    ...
    col.number("work_order_qty", "지시중량", C.U, C.U, C.U, true, "text"),
...
export default ItfPackingCreateSet;
