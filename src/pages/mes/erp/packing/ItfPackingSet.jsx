...
function ItfPackingSet() {
  ...
  const colMixed = [
    ...
    col.text("input_dept_nm", "투입부서", C.U, C.U, C.WIDTH_MIDDLE, C.U, true, "select"),
    col.text("input_lot_no", "투입Lot", C.U, C.U, C.U, C.U, true, "select"),
    col.number("input_qty", "투입중량", C.U, C.U, C.U, true, "select"),
    col.id("input_unit_cd", "input_unit_cd", C.HIDDEN_ID),
    col.text("input_unit_nm", "단위", C.U, C.U, C.U, "center", true, "select"),

    col.date("in_date", "투입일자", C.U, C.U, true, "select"),

    col.id("in_emp_cd", "in_emp_cd", C.HIDDEN_ID),
    col.text("in_emp_nm", "투입자", C.U, C.U, C.U, "center", true, "select"),

    col.id("stock_dept_cd", "stock_dept_cd", C.HIDDEN_ID),
    col.text("stock_dept_nm", "재고부서", C.U, C.U, C.U, C.U, true, "select"),
    col.date("stock_in_date", "재공일자", C.U, C.U, true, "select"),
