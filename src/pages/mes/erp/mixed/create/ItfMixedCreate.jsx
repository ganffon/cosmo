  ...
  const onMerge = () => {
    ...
    if (isLeftExtend) {
      ...
      setIsSnackOpen({
        ...isSnackOpen,
        open: true,
        message: "혼합실적 상세 (MES) 펼치기 상태에서 동작합니다.",
        severity: "warning",
        location: "topCenter",
      });
    }
  ...
  return (
    <ModalWrapMulti width={"95%"} height={"95%"}>
      ...
      <S.ShadowBoxGrid height={"190px"} width={"100%"}>
        <S.GridTitleWrap>
          <S.GridTitle>{"혼합실적 I/F 등록"}</S.GridTitle>
          <S.GridButtonWrap>
      ...
      <S.BottomWrap>
        <S.ShadowBoxGrid height={"99%"} width={isLeftExtend ? "1500px" : "250px"}>
          <S.GridTitleWrap>
            <S.GridTitle>{"혼합실적 상세 (MES)"}</S.GridTitle>
            <S.GridButtonWrap>
