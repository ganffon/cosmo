...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    setResultDay(
      GetTestValAndCreateAtDay(strJsonDay, "create_at", "testVal", "testVal2", "testVal3", "goal", "goal2", "goal3")
    );
    setResultStr(
      GetTestValAndCreateAtString(strJsonStr, "line_cd", "testVal", "testVal2", "testVal3", "goal", "goal2", "goal3")
    );
  }, []);
  ...
  for (let i = 0; i < series1.length; i++) {
    ...
    myValWithGoals.push({
      x: categories[i],
      y: series1[i],
      goals: [{ name: "Expected", value: goal1[i], strokeHeight: 5, strokeColor: "#775DD0", strokeWidth: 15 }],
    });
    myValWithGoals2.push({
      x: categories[i],
      y: series2[i],
      goals: [{ name: "Expected", value: goal2[i], strokeHeight: 5, strokeColor: "#775DD0", strokeWidth: 15 }],
    });
    myValWithGoals3.push({
      x: categories[i],
      y: series3[i],
      goals: [{ name: "Expected", value: goal3[i], strokeHeight: 5, strokeColor: "#775DD0", strokeWidth: 15 }],
    });
  }
