...
import { WIDTH_SUPER_SHORT, WIDTH_SHORT, WIDTH_MIDDLE, WIDTH_LONG, WIDTH_SUPER_LONG, MODAL_BACK_COLOR, NORMAL_BACK_COLOR } from "constant/Grid.js";
  ...
  const columnsHeader = {
    ...
    complexColumns: [
      ...
      },
      {
        ...
        name: "C",
        childNames: [
          "ns=2;s=계량공정(외부)온습도계.계량공정(외부)온습도계.humidity",
          "ns=2;s=계량공정(외부)온습도계.계량공정(외부)온습도계.temperture",
        ],
      },
      {
        header: "첨가제측정실",
        name: "D",
        childNames: [
          "ns=2;s=계량공정(첨가제측정실)온습도계.계량공정(첨가제측정실)온습도계.humidity",
          "ns=2;s=계량공정(첨가제측정실)온습도계.계량공정(첨가제측정실)온습도계.temperture",
        ],
      },
      {
        header: "소성로",
