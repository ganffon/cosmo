...
function ProductionOrderSet(
  ...
  const columnsHeader = [
    ...
    col.text("prod_cd", CN.prod_cd, false, false, C.WIDTH_SHORT, false, false, false, false, false),
    col.text("prod_nm", CN.prod_nm, false, false, C.WIDTH_SHORT, false, false, false, false, false),
