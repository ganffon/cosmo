...
function SubdivisionSet(isEditModeHeader, isEditModeDetail, isNewDetail, barcodePrintDetail, barcodePrintHeader) {
  ...
  const columnsHeader = [
    ...
    col.date("subdivision_date", CN.subdivision_date, isEditModeHeader, C.WIDTH_SHORT),
    ...
    col.button("barcode_no", CN.barcode_no, CN.barcode_no, barcodePrintHeader, false),
  ...
  const columnsDetail = [
    ...
    col.text("lot_no", CN.lot_no, isEditModeDetail, false, C.WIDTH_MIDDLE),
    col.number("before_subdivision_qty", CN.before_subdivision_qty, isEditModeDetail, C.WIDTH_SHORT, false),
    col.number("after_subdivision_qty", CN.after_subdivision_qty, isEditModeDetail, C.WIDTH_SHORT, false),
  ...
  const columnsModalHeader = [
    ...
    col.number("total_qty", CN.total_qty, false, C.WIDTH_SHORT, !isNewDetail),
  ...
  const columnsSelectProd = [
    col.id("prod_id", CN.prod_id, C.HIDDEN_ID),
    col.text("prod_cd", CN.prod_cd, false, false, C.WIDTH_MIDDLE, C.U, false, "select"),
    col.text("prod_nm", CN.prod_nm, false, false, C.WIDTH_MIDDLE, C.U, false, "select"),
  ];
  const inputSet = [
    {
      id: "prod_cd",
