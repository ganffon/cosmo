...
function SubdivisionAllSet(isEditModeHeader, isEditModeDetail, isNewDetail, barcodePrintDetail, barcodePrintHeader) {
  ...
  const columnsHeader = [
    ...
    col.text("prod_cd", CN.prod_cd, C.U, true),
...
export default SubdivisionAllSet;
