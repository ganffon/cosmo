...
function WeightPanelSet(
  ...
  const columnsWeight = [
    ...
    col.id("prod_id", CN.prod_id, C.HIDDEN_ID),
    col.text("prod_class_nm", CN.prod_class_nm, C.U, C.U, C.U, C.U, C.U, C.U, C.U, true),
    col.button("barcodeScan", "바코드 스캔", "바코드 스캔", onBarcodeScanButton),
    col.text("prod_cd", CN.prod_cd, C.U, C.U, C.WIDTH_MIDDLE, C.U, C.U, C.U, C.U, true),
    col.text("prod_nm", CN.prod_nm, C.U, C.U, C.WIDTH_MIDDLE, C.U, C.U, C.U, C.U, true),
    col.text("prod_std", CN.prod_std, C.U, C.U, C.WIDTH_MIDDLE, C.U, C.U, C.U, C.U, true),
