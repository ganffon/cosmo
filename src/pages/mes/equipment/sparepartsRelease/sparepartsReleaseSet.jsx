...
function SparePartReleaseSet(isEditMode) {
  ...
  const columns = [
    ...
    col.select("equip_detail_nm", CN.equip_detail_nm, isEditMode, C.WIDTH_SHORT),
    col.id("inv_from_store_id", CN.inv_from_store_id, C.HIDDEN_ID),
    col.text("inv_from_store_nm", CN.inv_from_store_nm, false, false, C.WIDTH_SHORT),
    col.id("inv_from_location_id", CN.inv_from_location_id, C.HIDDEN_ID),
    col.text("inv_from_location_nm", CN.inv_from_location_nm, false, false, C.WIDTH_SHORT),
  ...
  const columnsModalSelectProduct = [
    ...
    col.text("prod_cd", CN.prod_cd, false, false, C.WIDTH_MIDDLE),
    col.text("prod_nm", CN.prod_nm, false, false, C.WIDTH_MIDDLE, C.U, C.U, "select"),
    col.text("lot_no", CN.lot_no, false, false, C.WIDTH_MIDDLE, C.U, C.U, "select"),
    col.number("stock", CN.stock, false, C.WIDTH_SHORT, false),
    col.id("store_id", CN.store_id, C.HIDDEN_ID),

    col.text("store_cd", CN.store_cd, false, true, C.WIDTH_MIDDLE, C.U, C.U, "select"),
    col.text("store_nm", CN.outgo_store_nm, false, false, C.WIDTH_MIDDLE, C.U, C.U, "select"),
    col.id("location_id", CN.location_id, C.HIDDEN_ID),
    col.text("location_cd", CN.location_cd, false, true, C.WIDTH_MIDDLE, C.U, C.U, "select"),
    col.text("location_nm", CN.location_nm, false, false, C.WIDTH_MIDDLE, C.U, C.U, "select"),
  ];

  const columnsModalSelectEquipDetail = [
    col.id("equip_id", CN.equip_id, C.HIDDEN_ID),

    col.text("equip_cd", CN.equip_cd, false, false, C.WIDTH_SHORT, false, false, true),
  ...
  const columnsModalSelectStore = [
    ...
    col.text("from_location_nm", CN.from_location_nm, false, false, C.WIDTH_SHORT),
  ];
  ...
  const columnsModalSelectReleaseUser = [
    ...
    col.text("worker_group_nm", CN.worker_group_nm, false, true, C.WIDTH_MIDDLE),
  ];
  ...
  const columnsModalSelectLine = [
    col.id("line_id", CN.line_id, C.HIDDEN_ID),
    col.text("line_nm", CN.line_nm, false, false, C.WIDTH_MIDDLE, false, false, true),
  ];
